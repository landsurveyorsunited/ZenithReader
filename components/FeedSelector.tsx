...
import { SettingsIcon, SearchIcon, ChevronDownIcon, OfflineIcon, WarningIcon, LoadingSpinnerIcon } from './Icons';
...
export default function FeedSelector({ feeds, selectedFeed, onSelectFeed, onOpenSettings, searchQuery, onSearchChange, isOnline, isDataStale, refreshingFeedUrl }: FeedSelectorProps) {
        ...
        <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
          <div className="flex items-center flex-shrink-0" ref={dropdownRef}>
            <img 
              ...
              className="h-8 w-8 mr-2 sm:mr-3 rounded-md flex-shrink-0"
            />
            <div className="relative">
              ...
              >
                <span className="truncate max-w-[120px] xs:max-w-[150px] sm:max-w-[250px] md:max-w-[300px]">
             ...
             {selectedFeed && (
                <div className="relative">
                    ...
                    <input
                        type="search"
                        placeholder="Search..."
                        title={`Search in ${selectedFeed.title}`}
                        value={searchQuery}
